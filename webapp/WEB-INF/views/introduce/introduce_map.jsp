...
<div class="box" id="no-drag">
	...
	<div class="map_box" div class="intro_header" style="z-index: 1">
		<div class="map_sub">오시는 길</div>
		<div class="mapp">
			<div class="map" div class="intro_header" style="z-index: 1">
				<%@ include file="map.html"%>
			</div>
		</div>
		<div class="map_text">
			<div class="map_add"><i class="fas fa-dot-circle"></i><strong>ADD</strong>서울특별시 금천구 가산디지털2로 98, 1동 608호(가산동,롯데IT캐슬)</div>
			<div class="map_num"><i class="fas fa-dot-circle"></i><strong>TEL</strong>02-851-8030</div>
		</div>
	</div>
